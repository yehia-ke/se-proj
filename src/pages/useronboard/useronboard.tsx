...
export default function UserOnboardPage(props: { disableCustomTheme?: boolean }) {
  ...
  const validateInputs = () => {
    ...
    if (!num.value || num.value.length > 11) {
      setNumError(true);
      setNumErrorMessage('Please enter a valid phone number.');
      isValid = false;
    } else {
      setNumError(false);
      setNumErrorMessage('');
      ...
      <SignUpContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          ...
          >
            ...
            />
            <FormControl>
            <FormLabel>Are you an Alumni or Undergraduate</FormLabel>
            <RadioGroup
