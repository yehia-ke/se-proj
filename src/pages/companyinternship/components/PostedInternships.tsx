...
import { postedColumns, postedRows } from '../internals/data/gridData';
...
export default function PostedInternships() {
  const [rows, setRows] = React.useState(postedRows);
  const [filteredRows, setFilteredRows] = React.useState(postedRows);
    ...
    <Accordion defaultExpanded>
      ...
      <AccordionDetails>
        <Box sx={{ width: '100%', p: 2 }}>
          ...
          <DataGrid
            rows={filteredRows}
            columns={[...postedColumns, actionColumn]}
