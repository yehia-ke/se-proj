...
export default function EvaluationDialogue({
  ...
  const [evaluation, setEvaluation] = React.useState(
    'During my internship, I gained hands-on experience with React, TypeScript, and modern web development practices. The team was supportive and provided excellent mentorship. I worked on several key projects including the redesign of the company\'s dashboard interface and implementing new features for their client portal. The work environment was collaborative and I learned a great deal about agile development practices. This internship significantly improved my technical skills and professional development.'
  );
  ...
  const handleSaveDraft = () => {
    console.log('Saving draft:', { companyName, title, evaluation });
    setSnackbar({
      open: true,
      severity: 'success',
      ...
      >
        ...
        <DialogContent sx={{ backgroundColor: 'background.paper', pt: 1 }}>
          <Typography sx={{ mb: 2, color: 'text.primary' }}>
            How much would you recommend this company to other students?
          </Typography>
