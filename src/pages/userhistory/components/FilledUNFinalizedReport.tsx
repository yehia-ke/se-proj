...
export default function EvaluationDialogue({
  ...
  const [title, setTitle] = React.useState<string[]>(['Social Media', 'Content Marketing']);
  const [companyName, setCompanyName] = React.useState('GrowEasy Solutions');
  const [reportTitle, setReportTitle] = React.useState('Marketing Internship Evaluation');
  const [introduction, setIntroduction] = React.useState(
    'My internship at GrowEasy Solutions provided a valuable opportunity to explore digital marketing. I worked closely with the marketing team to support various campaigns. This experience enhanced my understanding of content strategies.'
  );
  const [body, setBody] = React.useState(
    'During my time at GrowEasy Solutions, I contributed to social media campaigns and created engaging content for the company blog. I analyzed campaign performance, which improved engagement by 15%. I also assisted in SEO optimization efforts. The internship was a great learning experience in marketing analytics.'
  );
  ...
  React.useEffect(() => {
    setCompanyName(initialCompanyName || 'GrowEasy Solutions');
  }, [initialCompanyName]);
