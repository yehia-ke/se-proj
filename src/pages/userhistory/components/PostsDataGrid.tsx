    ...
    <Box sx={{ width: '100%' }}>
      ...
      >
        <DialogTitle sx={{ color: 'text.primary', backgroundColor: 'background.paper' }}>
          {selectedPost?.postTitle} - {selectedPost?.postType}
        </DialogTitle>
        <Divider />
        <DialogContent sx={{ backgroundColor: 'background.paper' }}>
          {selectedPost && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Typography sx={{ color: 'text.primary' }}>
                <strong>Company Name:</strong> {selectedPost.companyName}
              </Typography>
              <Typography sx={{ color: 'text.primary' }}>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    fontWeight: 500,
                    backgroundColor:
                      selectedPost.status === 'Accepted' ? 'success.main' :
                      selectedPost.status === 'Rejected' ? 'error.main' :
                      'warning.main',
                  }}
                >
                  {selectedPost.status}
              ...
              {selectedPost.postType === 'Evaluation' && selectedPost.evaluationData && (
                <>
                  <Typography sx={{ color: 'text.primary' }}>
              ...
              {selectedPost.postType === 'Report' && selectedPost.reportData && (
                <>
                  <Typography sx={{ color: 'text.primary' }}>
                    <strong>Report Title:</strong> {selectedPost.reportData.reportTitle}
                  </Typography>
                  <Typography sx={{ color: 'text.primary' }}>
                    <strong>Content:</strong> {selectedPost.reportData.content}
                  </Typography>
                </>
              )}
            </Box>
